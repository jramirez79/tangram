...
export default class DataSource {
    ...
    */
    ...
    setTileSize (tile_size) {
        this.tile_size = parseInt(tile_size || 256);

        if (isNaN(this.tile_size) || this.tile_size < 256 || !Utils.isPowerOf2(this.tile_size)) {
            log({ level: 'warn', once: true },
                `Data source '${this.name}': 'tile_size' parameter must be a power of 2 greater than or equal to 256, but was ${tile_size}`);
            this.tile_size = 256;
        }
